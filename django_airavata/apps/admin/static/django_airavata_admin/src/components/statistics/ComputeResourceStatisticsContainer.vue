            ...
            <div class="col">
                <b-card header="Filter Options">
                    <b-input-group class="w-100 mb-2">
                        ...
                        <flat-pickr :value="dateRangeForHost" :config="dateConfig" @on-change="dateRangeChangedForHost"
                            class="form-control" />
                        <b-input-group-append>
                            <b-button @click="getPast24HoursForHost" variant="outline-secondary">Past 24 Hours</b-button>
                            <b-button @click="getPastWeekForHost" variant="outline-secondary">Past Week</b-button>
                        </b-input-group-append>
                    </b-input-group>
                    <template slot="footer">
                        <div class="d-flex justify-content-end">
                            <b-button @click="loadStatisticsForHost" class="ml-auto" variant="primary">Get
                                Statistics</b-button>
                        </div>
                    </template>
                </b-card>
