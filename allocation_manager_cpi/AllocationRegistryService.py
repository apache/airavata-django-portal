...
class Iface(object):
    ...
    def getAllRequests(self, authzToken, userName, userRole):
        """
    ...
    def canSubmitRequest(self, authzToken, userName):
        """
...
class Client(Iface):
    ...
    def getAllRequests(self, authzToken, userName, userRole):
        ...
        Parameters:
         ...
         - userRole
        """
        self.send_getAllRequests(authzToken, userName, userRole)
        return self.recv_getAllRequests()

    def send_getAllRequests(self, authzToken, userName, userRole):
        self._oprot.writeMessageBegin('getAllRequests', TMessageType.CALL, self._seqid)
        args = getAllRequests_args()
        args.authzToken = authzToken
    ...
    def recv_getAllRequests(self):
        ...
        if result.ae is not None:
            raise result.ae
        raise TApplicationException(TApplicationException.MISSING_RESULT, "getAllRequests failed: unknown result")
    ...
    def canSubmitRequest(self, authzToken, userName):
        ...
        Parameters:
         ...
         - userName
        """
        self.send_canSubmitRequest(authzToken, userName)
        return self.recv_canSubmitRequest()

    def send_canSubmitRequest(self, authzToken, userName):
        self._oprot.writeMessageBegin('canSubmitRequest', TMessageType.CALL, self._seqid)
        args = canSubmitRequest_args()
        args.authzToken = authzToken
        args.userName = userName
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
    ...
    def recv_canSubmitRequest(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = canSubmitRequest_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        ...
        if result.ae is not None:
            raise result.ae
        raise TApplicationException(TApplicationException.MISSING_RESULT, "canSubmitRequest failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["getAllRequests"] = Processor.process_getAllRequests
        ...
        self._processMap["canSubmitRequest"] = Processor.process_canSubmitRequest
    ...
    def process_getAllRequests(self, seqid, iprot, oprot):
        args = getAllRequests_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = getAllRequests_result()
        try:
            result.success = self._handler.getAllRequests(args.authzToken, args.userName, args.userRole)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except allocation_manager_models.ttypes.AllocationManagerException as ame:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("getAllRequests", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_canSubmitRequest(self, seqid, iprot, oprot):
        args = canSubmitRequest_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = canSubmitRequest_result()
        try:
            result.success = self._handler.canSubmitRequest(args.authzToken, args.userName)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except allocation_manager_models.ttypes.AllocationManagerException as ame:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("canSubmitRequest", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
createAllocationRequest_args.thrift_spec = (
    ...
    (2, TType.STRUCT, 'allocDetail', [allocation_manager_models.ttypes.UserAllocationDetail, None], None, ),  # 2
)
...
createAllocationRequest_result.thrift_spec = (
    ...
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
...
class createUserSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createUserSpecificResource_args)
createUserSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.STRUCT, 'allocDetail', [allocation_manager_models.ttypes.UserSpecificResourceDetail, None], None, ),  # 2
)
...
class createUserSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createUserSpecificResource_result)
createUserSpecificResource_result.thrift_spec = (
    (0, TType.I64, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class deleteUserSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteUserSpecificResource_args)
deleteUserSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.I64, 'projectId', None, None, ),  # 2
...
class deleteUserSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteUserSpecificResource_result)
deleteUserSpecificResource_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class getUserSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getUserSpecificResource_args)
getUserSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.I64, 'projectId', None, None, ),  # 2
)
...
class getUserSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getUserSpecificResource_result)
getUserSpecificResource_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [allocation_manager_models.ttypes.UserSpecificResourceDetail, None], False), None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class updateUserSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(updateUserSpecificResource_args)
updateUserSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.I64, 'projectId', None, None, ),  # 2
    (3, TType.LIST, 'listUserSpecificResource', (TType.STRUCT, [allocation_manager_models.ttypes.UserSpecificResourceDetail, None], False), None, ),  # 3
)
...
class updateUserSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(updateUserSpecificResource_result)
updateUserSpecificResource_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class getAllRequests_args(object):
    """
    Attributes:
     - authzToken
     - userName
    ...
    def __init__(self, authzToken=None, userName=None, userRole=None,):
        self.authzToken = authzToken
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.userRole = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getAllRequests_args')
        if self.authzToken is not None:
            oprot.writeFieldBegin('authzToken', TType.STRUCT, 1)
            self.authzToken.write(oprot)
            oprot.writeFieldEnd()
        ...
        if self.userRole is not None:
            oprot.writeFieldBegin('userRole', TType.STRING, 3)
            oprot.writeString(self.userRole.encode('utf-8') if sys.version_info[0] == 2 else self.userRole)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
    ...
    def validate(self):
        ...
        if self.userRole is None:
            raise TProtocolException(message='Required field userRole is unset!')
        return
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getAllRequests_args)
getAllRequests_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.STRING, 'userName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'userRole', 'UTF8', None, ),  # 3
)


class getAllRequests_result(object):
    """
    Attributes:
     - success
     - ame
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('getAllRequests_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.LIST, 0)
            oprot.writeListBegin(TType.STRUCT, len(self.success))
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getAllRequests_result)
getAllRequests_result.thrift_spec = (
...
updateRequestByReviewer_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.STRUCT, 'reviewerAllocationDetail', [allocation_manager_models.ttypes.ReviewerAllocationDetail, None], None, ),  # 2
)
...
class createReviewerSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createReviewerSpecificResource_args)
createReviewerSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.STRUCT, 'allocDetail', [allocation_manager_models.ttypes.ReviewerSpecificResourceDetail, None], None, ),  # 2
)
...
class createReviewerSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(createReviewerSpecificResource_result)
createReviewerSpecificResource_result.thrift_spec = (
    (0, TType.I64, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class deleteReviewerSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteReviewerSpecificResource_args)
deleteReviewerSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.I64, 'projectId', None, None, ),  # 2
    (3, TType.STRING, 'specificResource', 'UTF8', None, ),  # 3
...
class deleteReviewerSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deleteReviewerSpecificResource_result)
deleteReviewerSpecificResource_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class getReviewerSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getReviewerSpecificResource_args)
getReviewerSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.I64, 'projectId', None, None, ),  # 2
)
...
class getReviewerSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getReviewerSpecificResource_result)
getReviewerSpecificResource_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [allocation_manager_models.ttypes.ReviewerSpecificResourceDetail, None], False), None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class updateReviewerSpecificResource_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(updateReviewerSpecificResource_args)
updateReviewerSpecificResource_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.I64, 'projectId', None, None, ),  # 2
    (3, TType.LIST, 'listReviewerSpecificResource', (TType.STRUCT, [allocation_manager_models.ttypes.ReviewerSpecificResourceDetail, None], False), None, ),  # 3
)
...
class updateReviewerSpecificResource_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(updateReviewerSpecificResource_result)
updateReviewerSpecificResource_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class getAllAssignedReviewersForRequest_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getAllAssignedReviewersForRequest_args)
getAllAssignedReviewersForRequest_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.I64, 'projectId', None, None, ),  # 2
)
...
class getAllAssignedReviewersForRequest_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getAllAssignedReviewersForRequest_result)
getAllAssignedReviewersForRequest_result.thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT, [allocation_manager_models.ttypes.ProjectReviewer, None], False), None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class getRemainingAllocationUnits_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getRemainingAllocationUnits_args)
getRemainingAllocationUnits_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
...
class getRemainingAllocationUnits_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(getRemainingAllocationUnits_result)
getRemainingAllocationUnits_result.thrift_spec = (
    (0, TType.I64, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class deductAllocationUnits_args(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deductAllocationUnits_args)
deductAllocationUnits_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.STRING, 'specificResource', 'UTF8', None, ),  # 2
...
class deductAllocationUnits_result(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(deductAllocationUnits_result)
deductAllocationUnits_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
...
class canSubmitRequest_args(object):
    """
    Attributes:
     - authzToken
     - userName
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('canSubmitRequest_args')
        if self.authzToken is not None:
            oprot.writeFieldBegin('authzToken', TType.STRUCT, 1)
            self.authzToken.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(canSubmitRequest_args)
canSubmitRequest_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'authzToken', [airavata.model.security.ttypes.AuthzToken, None], None, ),  # 1
    (2, TType.STRING, 'userName', 'UTF8', None, ),  # 2
)
...
class canSubmitRequest_result(object):
    """
    Attributes:
     - success
     - ame
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('canSubmitRequest_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.BOOL, 0)
            oprot.writeBool(self.success)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(canSubmitRequest_result)
canSubmitRequest_result.thrift_spec = (
    (0, TType.BOOL, 'success', None, None, ),  # 0
    (1, TType.STRUCT, 'ame', [allocation_manager_models.ttypes.AllocationManagerException, None], None, ),  # 1
    (2, TType.STRUCT, 'ae', [airavata.api.error.ttypes.AuthorizationException, None], None, ),  # 2
)
